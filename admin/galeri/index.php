...
<div class="row mb-3 align-items-center">
    ...
    <div class="col-sm-6 text-sm-end mt-2 mt-sm-0">
        <a href="create.php" class="btn btn-navy fw-medium">
            <i class="bi bi-upload me-1"></i> Muat Naik Media Baru
        </a>
    </div>
</div>
                    ...
                    <div class="card h-100 shadow-sm border rounded-3 overflow-hidden">
                        ...
                        <div class="card-body p-3 d-flex flex-column justify-content-between">
                            <div>
                                ...
                                <p class="text-muted small mb-0">Dimuat naik oleh: <strong><?php echo sanitize($row['nama_uploader'] ?: 'Sistem'); ?></strong></p>
                            ...
                            <div class="mt-3 pt-2 border-top">
                                <form action="delete.php" method="POST" onsubmit="return confirm('Adakah anda pasti untuk memadam fail media ini? Tindakan ini akan memadam fail fizikal dari pelayan.');">
                                    ...
                                    <button type="submit" class="btn btn-sm btn-outline-danger w-100 d-flex align-items-center justify-content-center gap-1">
                                        <i class="bi bi-trash"></i> Padam Media
                                    </button>
                                </form>
                            </div>
                        </div>
